...
class _WalletService implements WalletService {
  ...
  Future<List<Wallet>> getWallets() async {
    ...
    final _options = _setStreamType<List<Wallet>>(
  ...
  @override
  Future<Wallet> createWallet({required WalletRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<Wallet> getWalletDetail({required int walletId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Transaction> createDepositTransaction({
    ...
    required TransactionRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<Transaction> createWithdrawalTransaction({
    ...
    final _options = _setStreamType<Transaction>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${walletId}/transactions/withdrawal',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
